...
export class HomeComponent implements OnInit {
  ...
  partnersData = {
    ...
    partners: [
      ...
      { name: "AGR GROUP", logo: "/assets/images/partenaire_clients/AGR GROUP.png" },
      ...
      { name: "ASB AGRO", logo: "/assets/images/partenaire_clients/ASB AGRO.png" },
      { name: "ASB CONSULTING", logo: "/assets/images/partenaire_clients/ASB CONSULTING.png" },
      ...
      { name: "COOPERATION SUISSE", logo: "/assets/images/partenaire_clients/COOPERATION SUISSE.png" },
      { name: "Copargo", logo: "/assets/images/partenaire_clients/copargo.jpg" },
      { name: "COUR SUPREME", logo: "/assets/images/partenaire_clients/COUR SUPREME.png" },
      ...
      { name: "DIOCESE DE PARAKOU", logo: "/assets/images/partenaire_clients/DIOCESE DE PARAKOU.jpg" },
      ...
      { name: "DORSCH IMPACT", logo: "/assets/images/partenaire_clients/DORSCH IMPACT.png" },
      ...
      { name: "GIZ BENIN", logo: "/assets/images/partenaire_clients/GIZ BENIN.png" },
      { name: "GIZ TOGO", logo: "/assets/images/partenaire_clients/GIZ TOGO.jpg" },
      ...
      { name: "Megnon Consulting", logo: "/assets/images/partenaire_clients/Megnon Consulting.png" },
      ...
      { name: "SG CONSULTING", logo: "/assets/images/partenaire_clients/SG CONSULTING.png" },
      { name: "SNV", logo: "/assets/images/partenaire_clients/SNV.png" },
      { name: "Sô Ava", logo: "/assets/images/partenaire_clients/Sô Ava.jpg" },
      { name: "SOS CIVISME", logo: "/assets/images/partenaire_clients/SOS CIVISME.jpeg" },
      ...
      { name: "TRESOR PUBLIC", logo: "/assets/images/partenaire_clients/TRESOR PUBLIC.jpg" },
      ...
      { name: "US INFORMATIQUE", logo: "/assets/images/partenaire_clients/US INFORMATIQUE.png" },
